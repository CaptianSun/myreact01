...
export default function Body() {
    ...
    */
    ...
    => 입력 member {name:'홍길동', gender:'M', birth:'2025-02-14', info:'하이'}
    => 성별 변경 : {name:'홍길동', gender:'M', birth:'2025-02-14', info:'하이', gender:'new'}
    */
    ...
    //  { ...객체, 속성: 값 } 패턴의 동작 방식
    //  이 패턴은 객체를 업데이트할 때 기존 데이터를 유지하면서 특정 속성만 변경하는 방법입니다.
