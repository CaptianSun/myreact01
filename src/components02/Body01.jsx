...
// ** Css, 스타일 적용하기
// => JSX 인라인 스타일링 : style={{스타일...}} -> (중괄호 2중첩)
    ...
    if (boo1){
        return (
            <div className="body">
                ...
                <p>구조분해name={name}</p>
                <p>구조분해country={country}</p>
                <p>2. JSX Test 출력</p>
                <p>* 산술식: n1+n2={n1+n2}</p>
                <p>* 문자식: s1+s2={s1+s2}</p>
                {/* <p>* 논리식: boo1={boo1}, AND={boo1 && boo2}, 관계식={s1===s2}</p> 
                    => boolean값은 toString() 메서드로 문자화 해야 출력 가능함 */}
                ...
                <p>* 삼항식 Test</p>
                <p>~ n1+n2의 값이 짝수면 "짝수", 홀수면 "홀수" 출력하기</p>
                <p>~ n1+n2의 결과는 {(n1+n2)%2===0 ? "짝수" : "홀수"} 입니다.</p>    
            </div>
        );
    } else{
        return (
            <div className="body">
                ...
                <img src={img1} alt={"imageTest"} style={{width:100,height:150}} />
                &nbsp;&nbsp;
                <button name="apple" onClick={clickTest}>Apple : 콜백함수 방식</button>&nbsp;&nbsp;
                <button name="banana" onClick={(event)=>{clickTest(event)}}>banana : 직접기술 방식</button>
